...
export default function FinalCTA() {
  ...
  return (
    <section className="border-t border-line-soft bg-primary">
        ...
        <div className="mt-8 flex justify-center">
          {isLoading ? (
            ...
            <Link
              ...
              className="flex h-12 items-center gap-2 rounded-lg bg-white px-6 font-medium text-primary transition-colors hover:bg-white/90"
            >
